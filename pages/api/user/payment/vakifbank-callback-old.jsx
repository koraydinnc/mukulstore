...
async function updateOrderStatus(orderId, status, paymentDetails) {
  try {
    ...
    // API route içinde olduğumuz için, doğrudan import edebiliriz veya fetch kullanabiliriz
    const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://mukulstore.com';
    const createOrderUrl = `${baseUrl}/api/admin/orders-5534/create`;
    
    console.log('Calling order creation API:', createOrderUrl);
